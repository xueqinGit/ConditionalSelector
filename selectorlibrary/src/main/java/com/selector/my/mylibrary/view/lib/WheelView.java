package com.selector.my.mylibrary.view.lib;
...
import com.selector.my.mylibrary.R;
import com.selector.my.mylibrary.view.adapter.WheelAdapter;
import com.selector.my.mylibrary.view.listener.OnItemSelectedListener;
import com.selector.my.mylibrary.view.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
       ...
       /* textColorOut = getResources().getColor(R.color.pickerview_wheelview_textcolor_out);
        ...
        selectTextSize = getResources().getDimensionPixelSize(R.dimen.pickerview_textsize);
        ...
        if (attrs != null) {
            ...
            selectTextSize = a.getDimensionPixelOffset(R.styleable.pickerview_pickerview_textSize, selectTextSize);
    ...
    private void initPaints() {
        ...
        paintCenterText.setTextSize(selectTextSize);
...
//            paintCenterText.setTextSize(textSize);
    ...
    public final void setSelectTextSize(float size) {
        if (size > 0.0F) {
            selectTextSize = (int) (context.getResources().getDisplayMetrics().density * size);
            paintCenterText.setTextSize(selectTextSize);
        }
    }
