...
import com.selector.my.mylibrary.view.adapter.ArrayWheelAdapter;
...
public class WheelOptions<T> {
    ...
    public void setSelectTexSize(int textSize) {
        wv_option1.setSelectTextSize(textSize);
        wv_option2.setSelectTextSize(textSize);
        wv_option3.setSelectTextSize(textSize);
    }
    ...
    public int getSelectwv1(){
        return  wv_option1.getCurrentItem();
    }
