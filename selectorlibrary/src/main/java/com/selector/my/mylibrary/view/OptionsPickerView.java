package com.selector.my.mylibrary.view;
...
import com.selector.my.mylibrary.view.listener.CustomListener;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private int Size_Select;//选中内容文字大小
    ...
    public OptionsPickerView(Builder builder) {
        ...
        this.Size_Select=builder.Size_Select;
        ...
        this.addClickListener = builder.addClickListener;
    ...
    public static class Builder {
        ...
        private int  Size_Select=18;//选中内容文字大小
        ...
        public Builder setSubmitClickListener(View.OnClickListener clickListener) {
            this.submitClickListener = clickListener;
            return this;
        }

        public Builder setAddClickListener(View.OnClickListener clickListener) {
        ...
        public Builder setSelectTextSize(int Size_Select) {
    ...
    private void initView(Context context) {
        ...
        wheelOptions.setSelectTexSize(Size_Select);
    ...
    public int getCurrentItem1() {
        return wheelOptions.getSelectwv1();
    }
